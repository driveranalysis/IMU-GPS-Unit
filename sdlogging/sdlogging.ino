...
//---Getmotion9 code
//void MPU6050::getMotion6(int16_t* ax, int16_t* ay, int16_t* az, int16_t* gx, int16_t* gy, int16_t* gz, int16_t* mx, int16_t* my, int16_t* mz) {
...
//    *mx = (((int16_t)buffer[8]) << 8) | buffer[17];
//    *my = (((int16_t)buffer[10]) << 8) | buffer[19];
//    *mz = (((int16_t)buffer[12]) << 8) | buffer[21];
//}
