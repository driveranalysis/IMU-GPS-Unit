...
data->gy = IMU.getGyroX_rads();
data->gz = IMU.getGyroX_rads();

data->mx = IMU.getMagX_uT();
data->my = IMU.getMagX_uT();
data->mz = IMU.getMagX_uT();

data->mz = IMU.getTemperature_C();


//  &data->ax = &data->ax /16384.0;
//  &data->ay = &data->ay /16384.0;
//  &data->az = &data->az /16384.0;
//  &data->gx = &data->gx /131.0;
//  &data->gy = &data->gy /131.0;
//  &data->gz = &data->gz /131.0;
}
